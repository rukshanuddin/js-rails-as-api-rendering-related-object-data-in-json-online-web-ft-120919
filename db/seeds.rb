...
Sighting.create(bird: bird_a, location: location_b)
Sighting.create(bird: bird_b, location: location_a)
Sighting.create(bird: bird_c, location: location_a)
Sighting.create(bird: bird_d, location: location_c)
Sighting.create(bird: bird_a, location: location_b)
